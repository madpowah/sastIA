      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Voici le résumé de vos audits de sécurité</p>
          </div>
          <Link to="/audits/new">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Vulnérabilités détectées</h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-orange-700">Élevée</span>
              </div>
            ...
            <div className="bg-yellow-50 rounded-xl p-4 border border-yellow-100">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-yellow-700">Moyenne</span>
              </div>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-blue-700">Basse</span>
              </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between p-6 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900">Audits récents</h2>
          ...
          {data?.recent_audits && data.recent_audits.length > 0 ? (
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-3 text-sm">
                      {audit.vulnerabilities_critical > 0 && (
                        <span className="badge-critical">{audit.vulnerabilities_critical} crit.</span>
                      )}
                      {audit.vulnerabilities_high > 0 && (
                        <span className="badge-high">{audit.vulnerabilities_high} haut.</span>
                      )}
                      {audit.vulnerabilities_medium > 0 && (
                        <span className="badge-medium">{audit.vulnerabilities_medium} moy.</span>
                      )}
                    </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-2">Aucun audit pour le moment</p>
              <p className="text-sm text-gray-400 mb-6">Lancez votre premier audit de sécurité</p>
              <Link to="/audits/new">
                <Button icon={<Search className="w-4 h-4" />}>
                  Lancer un audit
                </Button>
